...
final class UpdateManager: ObservableObject {
    ...
    private let releasesURL = URL(string: "https://api.github.com/repos/jawsbb/vocali/releases?per_page=100")!
    ...
    func checkForUpdates(userInitiated: Bool) async {
        let currentBuildTag = Bundle.main.infoDictionary?["VocaliBuildTag"] as? String
    ...
    private func performUpdate(downloadURL: URL, expectedSize: Int) async {
        ...
        let tempDir = fm.temporaryDirectory.appendingPathComponent("vocali-update-\(UUID().uuidString)")
        ...
        let dmgPath = tempDir.appendingPathComponent("Vocali.dmg")
        ...
        do {
            ...
            let stagingDir = fm.temporaryDirectory.appendingPathComponent("vocali-staged-\(UUID().uuidString)")

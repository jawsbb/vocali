...
private let realtimeLog = OSLog(subsystem: "com.jawsbb.vocali", category: "RealtimeTranscription")
...
final class RealtimeTranscriptionService {
    ...
    private let stateQueue = DispatchQueue(label: "com.jawsbb.vocali.realtime.state")
